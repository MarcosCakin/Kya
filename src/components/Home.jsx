...
function Home() {
    return (
        <section className="flex flex-col text-center items-center bg-darkLight text-light md:flex-row md:px-28 md:text-left" id="home">
            ...
            <div className="md:w-1/2 p-4 py-8 space-y-4">
                ...
                <button className="w-full p-2 border rounded text-primary hover:bg-primary hover:text-dark md:w-1/2"> View more... </button>
            </div>
